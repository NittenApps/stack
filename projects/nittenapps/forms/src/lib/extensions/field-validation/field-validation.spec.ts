...
function buildField(field: StackFieldConfigCache): StackFieldConfigCache {
...
function validate(field: StackFieldConfigCache, value: any, errors: ValidationErrors | null) {
  const formControl = new FormControl(value, { validators: field._validators });

  expect(formControl.errors).toEqual(errors);
}

function asyncValidate(field: StackFieldConfigCache, value: any, errors: ValidationErrors | null) {
...
describe('FieldValidationExtension: initialise field validators', () => {
  ...
  describe('validators', () => {
    ...
    describe('without validation option', () => {
      it(`using function`, () => {
        const field = buildField({
          validators: { custom: (form: FormGroup) => form.value },
        });
  ...
  it(`pass parameters to StackFormsConfig validator`, () => {
    const field = buildField({
      validators: {
